...
const Cards = () => {
  ...
  data-aos-duration='1600'>
    ...
    lg:flex-row gap-x-[32px]'>
      ...
      -mt-[38px] z-10 lg:-mt-[77px] mx-auto'>
              ...
              data-aos-delay='400'>
                ...
                lg:mb-[28px]'>
                  ...
                  lg:leading-7 font-bold text-heading mr-8'>
      ...
      {/* card 3 */}
      <div className='bg-white w-full max-w-[542px]
      mx-auto p-[14px] lg:p-[26px] mt-4 lg:-mt-[77px] z-10
      shadow-2xl rounded-md flex justify-between items-start'
      data-aos='fade-up'
      data-aos-delay='800'>
        {/* card text  */}
        <div className='max-w-[240px]'>
          <div className='flex items-center mb-4 lg:mb-8'>
            <h4 className='text-lg lg:text-2xl 
            lg:leading-7 font-bold text-heading mr-8'>Every-Day Open Master Classes.</h4>
