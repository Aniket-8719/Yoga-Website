...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ih2vxwm', 'template_sau0lxd', form.current, '5DTGB_jdUGBp7M8_R')
      .then((result) => {
        ...
        >
          ...
          <div className='flex-1 flex flex-col justify-center pl-8'
            ...
            <p className='mb-7 lg:mb-0'>
              Get in touch with  use for any kind of help. We are 
              here to  give you the best and also here to help  you 
              to find your yoga course.
            </p>
          </div>
          {/* from */}
          <form 
             ...
             ref={form} 
             className='flex-1 bg-white shadow-primary
