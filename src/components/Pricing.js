      ...
      <div className='container mx-auto'>
        ...
        <div className='text-center mb-7 lg:mb-[70px]'>
          ...
          <p className='max-w-[398px] mx-auto'
           data-aos='fade-up'
           data-aos-delay='700'>
            Pick a pricing plan and get started 
            your journey with us for build your 
            body and mind
          </p>
        </div>
        {/* cards  */}
        <div className='flex flex-col mx-auto items-center  gap-y-5
        lg:flex-row lg:gap-x-[33px]'>
                ...
                <div className='px-[30px] pt-[18px] pb-[30px]'>
                  ...
                  <ul className=' flex flex-col gap-3 mb-10'>
                    {list.map((item, index)=> {
                      ...
                      return (
                      <li className='border border-stroke-3 p-4 rounded-md 
                      flex items-center gap-4' key={index}>
                 ...
                 w-full left-0 right-0 px-[30px]'>
                 <button className={`${
                        index === currentIndex
                  ? 'bg-orange text-white'
                  : 'border-orange'
                } w-full h-[50px] rounded border 
                border-orange flex items-center 
                justify-center text-orange font-medium
                transition relative`}>
                  {buttonText}
                  {/* icon  */}
                  <div className={` ${
