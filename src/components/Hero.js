...
const Hero = () => {
  return <section className='min-h-[618px] lg:min-h-[815px] pt-9
    ...
    lg:flex-row lg:items-start pt-32'>
      <div className='flex-1 lg:mt-12'>
        ...
        data-aos-delay='600'>
          ...
          counteract the 
          Stresses of  modern life by becoming modern
          mindful and 
          compassionate.
        </p>
        {/* btn group */}
        ...
        data-aos-delay='700'>
          ...
          border-stroke-1 px-4 hover:bg-stroke-3 
          transition'>
            Learn more
          </button>
          <button className='mb-12'></button>
        </div>
      </div>
      {/* image */}
      ...
      lg:bg-none lg:w-auto'>
        ...
        data-aos='fade-left'
        data-aos-delay='600'>
          <div className='w-[234px] h-[234px] lg:w-[404px] lg:h-[744px]'>
            <Parallax className='w-full h-full  p-28 lg:p-16 lg:mt-0 '
            bgImage={Image}
