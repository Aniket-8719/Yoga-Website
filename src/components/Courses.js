  ...
  return (
    <section className='section-sm lg:section-lg'>
      <div className='container mx-auto'>
        ...
        {/* courses list */}
        <div className='flex flex-col gap-y-24 mb-
        lg:flex-row lg:gap-x-[33px] lg:mb-14 '>
          {courses.map((item, index)=>{
            // destructure item
            const {image, title, desc, link, delay} = item;
            return (
            <div className='flex flex-col rounded-[14px] mx-auto hover:shadow-primary transition w-full bg-white shadow-primary
            max-w-[368px] px-[18px] pb-[26px] lg:px-[28px] lg:pb-[38px]'  key={index}
            data-aos='fade-up'
            data-aos-delay={delay}>
              ...
              {/* bottom  */}
              <div className='flex items-centre justify-between mt-8 mb-2
              lg:mb-0'>
                {/* stars  */}
